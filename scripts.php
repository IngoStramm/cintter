...
function cintter_frontend_scripts()
{
    ...
    wp_register_script('cintter-script', CINTTER_URL . 'assets/js/cintter' . $min . '.js', array('jquery'), '1.0.0', true);

    wp_enqueue_script('cintter-script');

    wp_localize_script('cintter-script', 'ajax_object', array('ajax_url' => admin_url('admin-ajax.php')));
