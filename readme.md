...
- Cintter (Nome do plugin)
- cintter (nome dos arquivos, nome do text domain e slug da url do repositório)
- CINTTER_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- cintter_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Cintter, através do próprio sistema de atualizações do WordPress
