...
class CINTTER_Taxonomy
{
    ...
    protected function labels()
    {
        $default = array(
            ...
            'add_or_remove_items'        => sprintf(__('Add or Remove %ss', 'cintter'), $this->name),
            ...
            'parent_item'                => sprintf(__('Parent %s:', 'cintter'), $this->name),
            ...
            'new_item_name'              => sprintf(__('New %s', 'cintter'), $this->name),
            'all_items'                  => sprintf(__('All %ss', 'cintter'), $this->name),
            'separate_items_with_commas' => sprintf(__('Separate %ss with comma', 'cintter'), $this->name),
            'choose_from_most_used'      => sprintf(__('Choose from %ss most used', 'cintter'), $this->name)
        );
